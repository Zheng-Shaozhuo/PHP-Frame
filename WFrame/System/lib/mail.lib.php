<?php
     ...
     *  示例
     *  $obj = new Email();
     *  $obj->email_server = 'smtp.163.com';
     *  $obj->email_port = 25;
     *  $obj->email_user = 'zhuo370@163.com';
     *  $obj->email_password = '707288482';
     *  $obj->email_from = 'zhuo370@163.com';
     *  $obj->site_name = 'Msing_ZQ';
     *  $result = $obj->send('350058512@qq.com', '你好呀', '微调，求不出差错');
     */
    class Email{
        ...
        function __construct($email_server = null, $email_port = 25, $email_user = null, $email_password = null, $email_from = null, $site_name = null){
        	if(isset($email_server) || is_null($email_user) || is_null($email_password) || is_null(email_from) || is_null($site_name)){
        ...
        private function header($from=''){
            ...
            $header .= 'Message-ID: <'.gmdate('YmdHs').'.'.substr(md5($this->message.microtime()), 0, 6).rand(100000, 999999).'@'.$_SERVER['HTTP_HOST'].">{$this->email_delimiter}";
            return $header;
        }
